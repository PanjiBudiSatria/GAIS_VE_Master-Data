...
class TestGoodsAssessments(unittest.TestCase):
    ...
    def test_a_price_assessments_add(self):
        driver=self.driver
        ...
        driver.find_element(By.XPATH,"/html/body/div[4]/div/div/div/ul/li/a[6]/img").click()
        time.sleep(2)

        driver.find_element(By.XPATH,"//a[@title='Add Price Item']").click()
        time.sleep(1)
    ...
    def test_b_price_assessments_edit(self):
        driver=self.driver
        driver.maximize_window()
        driver.get("http://10.9.98.65/gais65/")
        time.sleep(3)
        ...
        driver.find_element(By.XPATH,"//a[@title='Edit Price Item']").click()
        time.sleep(1)
    ...
    def test_c_price_assessments_delete(self):
        driver=self.driver
        driver.maximize_window()
        driver.get("http://10.9.98.65/gais65/")
        time.sleep(3)
