...
class TestGoodsAssessments(unittest.TestCase):
    ...
    def test_a_goods_assessments_add(self):
        driver=self.driver
        ...
        driver.find_element(By.XPATH,"//a[@title='Add Goods Item']").click()
        time.sleep(1)
    ...
    def test_b_goods_assessments_edit(self):
        driver=self.driver
        driver.maximize_window()
        driver.get("http://10.9.98.65/gais65/")
        time.sleep(3)
        ...
        driver.find_element(By.XPATH,"//a[@title='Edit Goods Item']").click()
        time.sleep(1)
