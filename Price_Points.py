...
class TestPricePoints(unittest.TestCase):
    ...
    def test_a_price_points_add(self):
        driver=self.driver
        ...
        driver.find_element(By.XPATH,"//a[@title='Add Price Point']").click()
        time.sleep(1)
        ...
        response_data_point_name = driver.find_element(By.XPATH,"/html/body/div[4]/div/div/table/tbody/tr[4]/td[3]").text
        response_data_point_value = driver.find_element(By.XPATH,"/html/body/div[4]/div/div/table/tbody/tr[4]/td[4]").text
